...
swrd_fault_map = {0: ("Bad Cable Status", 55), 1: ("MKSU Protect", 80), 2: ("No Triggers", 68), 3: ("Modulator Fault", 67), 5: ("Low RF Power", 80), 6: ("Amplitude Mean", 70), 7: ("Amplitude Jitter", 75), 8: ("Lost Phase", 90), 10: ("Phase Jitter", 75), 14: ("No Sample Rate", 69)}
